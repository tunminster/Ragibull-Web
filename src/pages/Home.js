      ...
      <div className="About">
        <div className="container">
          <h2 className="About_Title">
            About Ragibull <span>Best product, Best service</span>
          </h2>
          <p>
            RagiBull local delivery and digital menu order. It's not just
            delivered to your home or office. Download the free RagiBull app and
            order from local delivery and collection restaurants and takeaways.
            We can all forget about paper takeaway menu which is not environment
            friendly, unnecessary cost and awkward phone orders. No more mumbled
            phone calls to busy restaurants. Use your postcode or device's
            location service to find local restaurants and takeaway shops to
            order. Why don't you use just make order form the app before you
            have just arrived to have fantastic meals or bites whether
            collection, dine in or takeaway.
          </p>
